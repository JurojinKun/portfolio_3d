...
const Portfolio = () => {
    ...
    return (
        <div>
            ...
            <Element name="aboutme" id="aboutme" style={{ height: '100vh', background: 'lightblue' }}>
                <AboutMe />
            </Element>
            <Element name="skills" id="skills" style={{ background: 'lightgreen' }}>
                <Skills />
            </Element>
            <Element name="experiences" id="experiences" style={{ height: '100vh', background: 'orange' }}>
                <Experiences />
            </Element>
            <Element name="projects" id="projects" style={{ height: '100vh', background: 'purple' }}>
                <Projects />
            </Element>
            <Element name="contactme" id="contactme" style={{ height: '100vh', background: 'brown' }}>
                <ContactMe />
            </Element>
        </div>
    );
