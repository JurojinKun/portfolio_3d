    ...
    >
      ...
      >
        {experience.points.map((point, index) => (
          ...
          >
            {point.includes("Référence:") || point.includes("Reference:") ? (
              <>
                <span>{point.split(/Référence|Reference/)[0]}</span>
                <br />{" "}
                <strong>
                  <span style={{ textDecoration: "underline" }}>
                    {point.match(/Référence|Reference/)[0]}
                  </span>
                  {point.split(/Référence|Reference/)[1]}
                </strong>
              </>
            ) : (
              <span>{point}</span>
...
const Experiences = ({ threshold }) => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [t("experiences.point_1_experience_3")],
    },
  ];
