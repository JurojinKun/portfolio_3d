...
const ContactMe = ({ menuOpened, threshold }) => {
  ...
  const handleSubmit = (e) => {
      ...
      if (
        ...
        setLoading(false);
        showAlertCustom(
          t("contact_me.title_error"),
          t("contact_me.content_error_1"),
          "error"
        );
      } else {
        ...
        emailjs
          ...
          .then(
            () => {
              setLoading(false);
              showAlertCustom(
                t("contact_me.title_validate"),
                t("contact_me.content_validate"),
                "success"
              );
              setForm({
                name: "",
  ...
  return (
    ...
    >
      <StarryBackground
        gradientTopLeft={false}
        gradientBottomRight={true}
        heightSection={contactmeHeight}
        widthSection={contactmeWidth}
      />
      <motion.div
        ref={ref}
        ...
        <div className="contactme-content">
          <div className="form-contactme">
            ...
            >
              ...
              >
                <span
                  className="fontBodyBoldContactMe"
                  style={{
                    marginBottom: "1rem",
                  }}
                >
                  {t("contact_me.title_name")}
                </span>
                <input
                  type="text"
                  name="name"
              ...
              <button type="submit" className="submit fontBodyBoldContactMe" disabled={menuOpened || loading}>
          ...
          <div className="image-container">
            <img
              src={astroContactMe}
              alt="Astro contact me"
              className="static-image"
            />
            <img
              src={enveloppeContactMe}
              alt="Enveloppe contact me"
